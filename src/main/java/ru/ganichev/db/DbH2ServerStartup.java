...
public class DbH2ServerStartup {
     ...
     */
    public static DataSource populateDatabase() throws SQLException {
        ...
        JdbcConnectionPool dataSrc = JdbcConnectionPool.create("jdbc:h2:mem:ExampleDb;DB_CLOSE_DELAY=-1;IFEXISTS=FALSE", "sa", "");

        //JdbcDataSource dataSrc = new JdbcDataSource();
        //dataSrc.setURL("jdbc:h2:mem:ExampleDb;DB_CLOSE_DELAY=-1;IFEXISTS=FALSE");
        //dataSrc.setUser("sa");
        //dataSrc.setPassword("");


        System.out.println("DataSource настроен и готов к использованию!");
